...
export const PwaInstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 left-6 md:left-auto md:max-w-md z-50 animate-bounce-short">
      <div className="bg-gradient-to-r from-indigo-900/90 via-slate-900/95 to-purple-900/90 backdrop-blur-xl border border-indigo-500/40 rounded-2xl p-5 shadow-2xl text-white">
        ...
        <div className="mt-4 flex items-center justify-end gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold rounded-xl text-xs shadow-lg shadow-indigo-500/30 transition transform hover:scale-105 active:scale-95"
          >
